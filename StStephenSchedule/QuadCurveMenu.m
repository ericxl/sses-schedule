...
#define NEARRADIUS 102.0f
#define ENDRADIUS 112.0f
#define FARRADIUS 125.0f
...
- (void)setExpanding:(BOOL)expanding
{
    ...
    // rotate add button
    float angle = self.isExpanding ? -M_PI_2-M_PI_4 : 0.0f;
    [UIView animateWithDuration:0.2f animations:^{
        _addButton.transform = CGAffineTransformMakeRotation(angle);
    }];
...
- (void)_expand
{
    ...
    positionAnimation.duration = .35f;
